...
**Public preview · v0 · public sources checked 2026-09-24**
...
| [BeanFit App](https://github.com/stevekkall-beansgc/beanfit-app) | Companion account and device flow for BeanFit recommendations. | Public [v0.4.4 release](https://github.com/stevekkall-beansgc/beanfit-app/releases/tag/v0.4.4) and [documented customer flow](https://github.com/stevekkall-beansgc/beanfit-app/blob/main/README.md#beanfit-app). A service component is confirmed internally; no public visitor demo URL is listed. Automatic update alerts are planned. |
